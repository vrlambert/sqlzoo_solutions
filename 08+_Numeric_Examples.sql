/* This section is based on the National Student Survey 2012
...
above to multiply the percentage by the response and divide by the
total response. Give your answer rounded to the nearest whole number. */
...
SELECT institution, SUM(sample), (SELECT sample
                                   ...
                                   WHERE question = 'Q01'
                                    ...
                                    AND subject = '(8) Computer Science') comp
  FROM nss x
 WHERE question='Q01'
   AND institution LIKE '%Manchester%'
GROUP BY institution
