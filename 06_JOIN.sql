-- Queries giving an introduction to join
...
/* 3 Modify 2 to show the player, teamid, stadium and mdate for
 every German goal. */
...
/* 8 The example query shows all goals scored in the
...
This will use "CASE WHEN" which has not been explained in
