...
-- 2 Show the countries in Europe with a per capita GDP greater
-- than 'United Kingdom'.
...
SELECT name,
 ...
 -- The following queries deal mostly with ALL statements --
...
-- 8 List each continent and the name of the country that comes
